...
abstract class BankAccount implements PrintToFile{
    ...
    //contructor
    public BankAccount(String a, String o, double b){
        accountNumber = a;
        ownerName = o;
        balance = b;
    }
    ...
    public void Print(String str){
        try{
            PrintWriter fout = new PrintWriter(new FileOutputStream(new File("appendt1.txt"),true));  
            fout.println(str);
            fout.close();  
        } catch (IOException e){
            e.printStackTrace();
...
class CheckingAccount extends BankAccount{
    ...
    //constructor
    public CheckingAccount(String a, String o, double b, int n){
        super(a,o,b);
    ...
    //methods
    public double pay(){
        if (numOfWrittenChecks-3>0){
            return (numOfWrittenChecks-maxNumOfChecks)*serviceCharge;
        }
        return 0;
    }
...
class SavingAccount extends BankAccount{
    ...
    public SavingAccount(String a, String o, double b, double i){
        super(a,o,b);
        interestRate = i;
    }
